...
const BookForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNotify('There is an Error with the server, please try later!');
    }
  };
    ...
    <>
      <div className="container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <span>
            <strong>Note:</strong> Please upload a chapter by chapter summary so that we can understand the full arc of the narrative.
            <br />
            If your book does not have chapters, please upload a detailed and comprehensive summary not to exceed 5,000 words.
            <br />
            <br />
            Acceptable file types: .Pdf, .Jpg, .Png, .Jpeg
          </span>
          <div>
